      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <motion.h1
            ...
            className="min-w-0 font-sans text-display font-bold leading-none tracking-tight text-ink-900 sm:text-display-md"
          >
        ...
        <div className="flex shrink-0 items-center gap-2">
          ...
          <div className="flex items-center gap-1">
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              onClick={goToday}
              className={`rounded-xl px-3 py-1.5 text-small font-semibold transition-all duration-150 cursor-pointer ${
                isTodaySelected
            ...
            <motion.button
              ...
              className="rounded-xl p-2 text-ink-500 transition-colors duration-150 hover:bg-paper-200/80 hover:text-ink-900 cursor-pointer"
            >
              ...
              {(calendarMode === 'week' ? currentWeekDays : cells).map((d) => {
                ...
                return (
                  <button
                    ...
                    aria-pressed={sel}
                    className={`group relative flex ${calendarMode === 'week' ? 'aspect-[4/5] sm:aspect-square' : 'aspect-square'} flex-col items-center justify-between rounded-xl p-1.5 transition-all duration-150 sm:rounded-2xl sm:p-2 cursor-pointer ${
                      sel
                  ...
                  >
                    ...
                    <span className="relative z-10 text-body sm:text-body-lg">
                      {d.getDate()}
                    </span>
      ...
      <div className="mt-8 space-y-4">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 border-b border-paper-200/80 pb-3">
          <div className="flex flex-wrap items-center gap-2">
            <h2 className="text-body-lg font-bold text-ink-900 sm:text-title">
            ...
            {selectedTasks.length > 0 && (
              <span className="text-small font-medium text-ink-400">
          ...
          <div className="flex items-center gap-1.5">
            {onOpenCreateModal && (
              <motion.button
                ...
                className="inline-flex items-center gap-1 rounded-xl bg-pine-600 px-3 py-1.5 text-small font-medium text-[#fbf9f5] shadow-xs transition-colors hover:bg-pine-700"
              >
        ...
        >
          ...
          <input
            ...
            className="min-w-0 flex-1 bg-transparent text-body-lg text-ink-900 placeholder:text-ink-400 outline-none"
          />
          {quickTitle.trim() && (
            <motion.button
              ...
              type="submit"
              className="rounded-lg bg-pine-600 px-2.5 py-1 text-caption font-semibold text-paper-50 shadow-2xs hover:bg-pine-700"
            >
              Add
            </motion.button>
          )}
        ...
        {selectedOpen.length === 0 && selectedDone.length === 0 ? (
          ...
          >
            ...
            <p className="mt-3 text-body-lg font-medium text-ink-700">No tasks due on this day</p>
            ...
            {selectedDone.length > 0 && (
              <div className="pt-2">
                <button
                  ...
                  className="flex items-center gap-1.5 text-caption font-semibold uppercase tracking-[0.12em] text-ink-400 hover:text-ink-600 transition-colors"
                >
                  <ChevronIcon
