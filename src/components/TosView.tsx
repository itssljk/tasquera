  ...
  return (
    ...
    >
      ...
      <div className="mt-8 space-y-8 text-[14.5px] leading-relaxed text-ink-700">
        ...
        <section className="space-y-3">
          <h2 className="text-[16px] font-semibold text-ink-900">2. Service Description & Local-First Philosophy</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-[16px] font-semibold text-ink-900">3. User Ownership & Data Retention</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-[16px] font-semibold text-ink-900">4. Acceptable Use</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-[16px] font-semibold text-ink-900">5. Disclaimer of Warranties</h2>
          <p>
        ...
        <section className="space-y-3">
          <h2 className="text-[16px] font-semibold text-ink-900">6. Modifications to Terms</h2>
          <p>
